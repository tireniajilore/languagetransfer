// Brian v3 rescue grid for English cognates.
//
// Goal: keep Brian on eleven_v3, but make English cognate prompts land as
// English by using stronger English anchors, optional language_code, and
// context fields. Outputs one combined MP3 plus the individual clips.
...
const OUT = path.join(__dirname, '..', 'out', 'tts-v3-rescue');
...
const clips = [
  {
    key: '01-en-metal-label',
    text: 'The English word is metal.',
    lang: 'en',
  },
  {
    key: '02-en-metal-command',
    text: 'Say the English word: metal.',
    lang: 'en',
  },
  {
    key: '03-en-metal-question',
    text: 'What about the English word metal?',
    lang: 'en',
  },
  {
    key: '04-en-metal-context',
    text: 'This is the English word first: metal.',
    lang: 'en',
  },
  {
    key: '05-en-natural-anchor',
    text: 'Now say this English word naturally: natural.',
    lang: 'en',
  },
  {
    key: '06-en-legal-anchor',
    text: 'What about the English word legal?',
    lang: 'en',
  },
  {
    key: '07-es-metal-control',
    text: 'En español, metal.',
    lang: 'es',
  },
  {
    key: '08-es-natural-control',
    text: 'En español, natural.',
    lang: 'es',
  },
];
...
async function synth(clip) {
  ...
  if (clip.previous_text) body.previous_text = clip.previous_text;
  if (clip.next_text) body.next_text = clip.next_text;
...
const paths = [];
console.log(`Brian · ${MODEL_ID} rescue grid\n`);
...
const combined = writeMp3('brian-v3-rescue-grid', paths);
fs.writeFileSync(
  ...
  [
    ...
    `Model: ${MODEL_ID}`,
    '',
    'Question: which English cognate prompts actually land English while keeping Brian v3 warmth?',
    '',
    'Clip order:',
